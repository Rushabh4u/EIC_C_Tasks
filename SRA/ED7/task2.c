...
int read_person(FILE *file, Person *person) {
    ...
    If it's the end of the file, return 0 (stop reading)
    */
    ...
    /* 
    Remove the newline character from the person's name if it exists
    */
    person->name[strcspn(person->name, "\n")] = '\0';

    /* 
    Read the person's birthdate (day, month, year) from the file
    */
